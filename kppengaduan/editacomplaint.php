                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <form method="POST" action="editacomplaintprocess.php" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group input-group">
                                                ...
                                                <input name="idcomplaint" class="form-control" value="<?php echo $idofcomplaintrecord; ?>" readonly>
                                            </div>
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input name="usercomplaint" class="form-control" value="<?php echo $rowdata['usercomplaint'];?>" />
                                        </div>
                                        <label>Number of Complaint Letter</label>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-envelope-square" ></i></span>
                                            <input name="numbercomplaint" class="form-control" value="<?php echo $rowdata['numberofcomplaintrecord'];?>" />
                                        </div>
                                        <label>Complaint Date</label>
                                        
                                        <div id="datepicker" class="form-group input-group date" data-date-format="yyyy-mm-dd">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            <input class="form-control" type="text" name="complaintdate" value="<?php echo $rowdata['complaintdate'];?>">
                                        </div>
                                        ...
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-tag" ></i></span>
                                            <input name="complainttitle" class="form-control" value="<?php echo $rowdata['complainttitle'];?>" />
                                        </div>
                                        <label>Complaint Received by :</label>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-inbox" ></i></span> 
                                            <input  class="form-control" type="text" name="complaintreceived" id="autocomplete-dynamic" style="width: 100%; border-width: 1px;" value="<?php echo $rowdata['complaintreceivedby'];?>" />
                                        </div>
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <select name="complaintmedia" class="form-control" value="<?php echo $rowdata['complaintmedia'];?>">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <select name="complainttype" class="form-control" value="<?php echo $rowdata['complainttype'];?>">
                                ...
                                <div class="col-md-8">
                                        <div class="form-group">
                                            <label>Complaint Information</label>
                                            <textarea name="complaintinformation" cols="100" rows="15"> <?php echo $rowdata['complaintinformation'];?></textarea>
