    ...
    <div class="col-md-6">                     
            <div class="panel panel-default">
                ...
                <tbody>
                        ...
                        <?php
                            $n=1;
                            $sql2 = "SELECT * FROM user WHERE lokasi='kapu'";
                            $result2 = mysqli_query($db,$sql2);
                            while($row2 = mysqli_fetch_array($result2)){
                                $uidfile=$row2['iduser'];
                                $sqlfile = "SELECT count(*) AS total_file FROM complaint INNER JOIN user ON userid = iduser WHERE photo<>'' OR video<>'' AND userid='$uidfile' AND lokasi='kapu' AND status='onprogress' ORDER BY total_file DESC";
                                $resultfile = mysqli_query($db,$sqlfile);
                                $rowfile = mysqli_fetch_array($resultfile);
                                
                                $sqlnofile = "SELECT count(*) AS total_file FROM complaint INNER JOIN user ON userid = iduser WHERE photo='' AND video='' AND userid='$uidfile' AND lokasi='kapu' AND status='onprogress' ORDER BY total_file DESC";
...
<div class="panel-body">
    <div class="col-md-3">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
            <?php
            $sqlfinished = "SELECT count(*) AS total_finished FROM complaint INNER JOIN user ON userid = iduser WHERE status='selesai' AND lokasi='kapu'";
        ...
        <div class="col-md-3">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
            <?php
            $sqlonprogress = "SELECT count(*) AS total_progress FROM complaint INNER JOIN user ON userid = iduser WHERE status='onprogress' AND lokasi='kapu'";
